...
//                        self.k_Constraint_ViewTxtview_Top.constant = 57.0
//                        self.k_contraint_ViewFields_Height.constant = 300.0
//                    }
//                    else if self.array_UserSocialSites.count == 2{
//                        self.k_Constraint_ViewTxtview_Top.constant = 100.0
//                        self.k_contraint_ViewFields_Height.constant = 345.0
//                    }
//                    else if self.array_UserSocialSites.count == 3{
//                        
//                        self.k_Constraint_ViewTxtview_Top.constant = 145.0
//                        self.k_contraint_ViewFields_Height.constant = 388.0
//                        
//                    }
                ...
                self.view_Skills.layer.borderColor = Global.macros.themeColor_pink.cgColor
                ...
                self.tblView_ActualSkills.layer.borderColor = Global.macros.themeColor_pink.cgColor
                self.tblView_MySkills.layer.borderWidth = 1.0
                self.tblView_MySkills.layer.borderColor = Global.macros.themeColor_pink.cgColor
                ...
                self.view_tableViews_SocialSites.layer.borderColor = Global.macros.themeColor_pink.cgColor
                ...
                self.tblView_UserSites.layer.borderColor = Global.macros.themeColor_pink.cgColor
                self.tblView_ActualSocialSites.layer.borderWidth = 1.0
                self.tblView_ActualSocialSites.layer.borderColor = Global.macros.themeColor_pink.cgColor
    ...
    func CustomBorder(searchbar : UISearchBar){
        ...
        searchTextField.attributedPlaceholder = NSAttributedString(string: "Search",attributes: [NSForegroundColorAttributeName: Global.macros.themeColor])
