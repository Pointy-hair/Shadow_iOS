...
open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    open var gridBackgroundColor = NSUIColor(red: 153.0/255.0, green: 143.0/255.0, blue: 189.0/255.0, alpha: 1.0)
    
    open var borderColor = NSUIColor(red: 153.0/255.0, green: 143.0/255.0, blue: 189.0/255.0, alpha: 1.0)
